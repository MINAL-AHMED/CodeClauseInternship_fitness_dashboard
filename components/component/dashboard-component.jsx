 ...
 * @see https://v0.dev/t/gD1itBRVlgJ
 */
    ...
    (<div className="flex flex-col w-full min-h-screen">
      ...
      <main className="grid gap-4 p-4 md:gap-8 md:p-10">
        <Card>
          ...
          <CardContent
            className="flex flex-col md:flex-row md:items-center md:justify-between md:gap-4 lg:gap-6">
            <div className="flex flex-col gap-1 md:flex-row md:items-center md:gap-2">
              <div className="flex items-center gap-2">
                <ActivityIcon className="w-6 h-6" />
                <div className="grid gap-1.5">
                  <p className="text-sm font-medium">Steps</p>
                  <p className="text-2xl font-semibold tracking-tighter">4,231</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col gap-1.5 md:flex-row md:items-center md:gap-2">
              <div className="flex items-center gap-2">
                ...
                <div className="grid gap-1.5">
                  ...
                  <p className="text-2xl font-semibold tracking-tighter">1h 23m</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div className="grid gap-1.5">
                  ...
                  <p className="text-2xl font-semibold tracking-tighter">98 bpm</p>
                </div>
              </div>
            </div>
          </CardContent>
              ...
              <CardContent className="p-0">
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">10:00am - 11:00am</p>
                  </div>
              ...
              <CardContent className="p-0">
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">5:00pm - 6:00pm</p>
                  </div>
                  <div className="ml-auto">
              ...
              <CardContent className="p-0">
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">3:00pm - 4:00pm</p>
                  </div>
                  <div className="ml-auto">
